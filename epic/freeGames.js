...
const getFreeGames = games => {
    for (let game of games) {
        ...
        if (!game?.promotions || !game.promotions?.promotionalOffers || game?.isCodeRedemptionOnly) {
            continue
        }
