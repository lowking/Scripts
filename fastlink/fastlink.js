...
const fastLinkPasswordKey = "fastLinkPassword"
const domainKey = "fastLinkDomain"
const userName = lk.getVal(fastLinkUserNameKey)
const password = lk.getVal(fastLinkPasswordKey)
const domain = lk.getVal(domainKey)
...
const BoxJsInfo = {
    ...
    "keys": [fastLinkUserNameKey, fastLinkPasswordKey],
    "script_timeout": 10
}

const BoxJsParam = {
    "script_url": "https://github.com/lowking/Scripts/blob/personal/fastlink/fastlink.js",
    "author": "@lowking",
