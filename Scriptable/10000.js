...
async function createWidget(w, pretitle, _subt, _flowRes, _voiceRes) {
    ...
    let isWD = await $.isWorkingDays(new Date(targetDate.setDate(now.getDate() + 1)), workingDaysFlag, holidayFlag)
