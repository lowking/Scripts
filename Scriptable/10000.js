...
if (config.runsInWidget) {
    ...
    $.log('手动运行')
    let enter = await $.widgetEnter([{name:{zh:"获取Cookie",en:"Get Cookie"}, callback: renderWebView}])
