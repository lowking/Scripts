            ...
            if (lk.isEmpty(storedList)) {
                ...
                try {
                    ...
                    if (Object.keys(storedList).length > 0) {
                        ...
                        lk.log(JSON.stringify(storedKeyList))
                        lk.log(JSON.stringify(curKeyList))
