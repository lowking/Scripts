const lk = new ToolKit('工具包使用示例', 'ToolKitDemo', {"httpApi": "ffff@10.0.0.9:6166"})
    ...
    return new class {
        ...
        boxJsJsonBuilder(t, s) {
            if (this.isNode()) {
                ...
                h.icons = [`${e}/mini/master/${this.id.toLocaleLowerCase()}.png`, `${e}/task/master/${this.id.toLocaleLowerCase()}.png`]
                h.keys = []
                h.settings = [{
        ...
        get(t, s = (() => {
            ...
            if (this.isSurge()) $httpClient.get(t, (t, i, e) => {
        ...
        costTime() {
            ...
            this.execCount++
            this.costTotalMs += i
            this.log(`${t}耗时【${e}】秒\n总共执行【${this.execCount}】次，平均耗时【${(this.costTotalMs / this.execCount / 1e3).toFixed(4)}】秒`)
