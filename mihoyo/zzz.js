...
function share(title, postId, cookie, dfp) {
...
async function getBbsPost(title) {
    return new Promise((resolve, _reject) => {
        lk.log(title)
        lk.get({
...
async function bbsSignIn(title, cookie, dfp) {
    return new Promise((resolve, _reject) => {
        lk.log(title)
        lk.post({
...
async function getZzzInfo(title, uid, cookie) {
    return new Promise((resolve, _reject) => {
        lk.log(title)
        lk.get({
