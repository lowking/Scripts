/*
绝区零维护状态监控-lowking-v1.0.0

cookie获取自己抓包，能不能用随缘
为了在版本维护结束的最快时间打开云绝区零排队
此脚本仅在维护期间使用, 过后请停止使用, 5秒钟执行一次, 可自行更改crontab调整
...
const BoxJsInfo = {
    ...
    "keys": [zzzCloudGameCookieKey, zzzComboTokenKey],
    "script_timeout": 700
}

const BoxJsParam = {
    "script_url": "https://github.com/lowking/Scripts/blob/master/mihoyo/maintenance.js",
    "author": "@lowking",
