...
[rewrite_local]
#微博超话签到
http-request https:\/\/weibo\.com\/p\/aj\/general\/button\?ajwvr=6&api=http:\/\/i\.huati\.weibo\.com\/aj\/super\/checkin max-size=0,script-path=weiboSTCookie.js
0 0 0,1 * * ? weiboST.js
#超话页面强制用pc模式打开
